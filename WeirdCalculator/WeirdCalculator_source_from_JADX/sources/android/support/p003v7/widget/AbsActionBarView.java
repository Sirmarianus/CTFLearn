...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0211R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, C0211R.styleable.ActionBar, C0211R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0211R.styleable.ActionBar_height, 0));
        a.recycle();
