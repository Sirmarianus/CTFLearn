    ...
    public void addToSolver(LinearSystem system, int group) {
        ...
        if (this.mHorizontalResolution != 2 && (group == Integer.MAX_VALUE || (this.mLeft.mGroup == group && this.mRight.mGroup == group))) {
            if (!useHorizontalRatio || this.mLeft.mTarget == null || this.mRight.mTarget == null) {
                applyConstraints(system, wrapContent, horizontalDimensionFixed, this.mLeft, this.mRight, this.f5mX, this.f5mX + width, width, this.mMinWidth, this.mHorizontalBiasPercent, useHorizontalRatio, inHorizontalChain, this.mMatchConstraintDefaultWidth, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth);
            } else {
            ...
            if (this.mBaselineDistance > 0) {
                ...
                if (group == Integer.MAX_VALUE || (this.mTop.mGroup == group && endAnchor.mGroup == group)) {
                    if (!useVerticalRatio || this.mTop.mTarget == null || this.mBottom.mTarget == null) {
                        applyConstraints(system, wrapContent2, verticalDimensionFixed, this.mTop, endAnchor, this.f6mY, this.f6mY + height, height, this.mMinHeight, this.mVerticalBiasPercent, useVerticalRatio, inVerticalChain, this.mMatchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight);
                ...
                if (!useVerticalRatio || this.mTop.mTarget == null || this.mBottom.mTarget == null) {
                    applyConstraints(system, wrapContent2, verticalDimensionFixed, this.mTop, this.mBottom, this.f6mY, this.f6mY + height, height, this.mMinHeight, this.mVerticalBiasPercent, useVerticalRatio, inVerticalChain, this.mMatchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight);
                } else {
