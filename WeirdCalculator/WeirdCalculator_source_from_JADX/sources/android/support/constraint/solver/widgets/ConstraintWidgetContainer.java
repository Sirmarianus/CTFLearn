        ...
        for (int i = 0; i < this.mHorizontalChainsSize; i++) {
            ...
            if (currentWidget != null) {
                if (this.flags[1]) {
                    ...
                    boolean isWrapContent = this.mHorizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? USE_SNAPSHOT : false;
        ...
        for (int i = 0; i < this.mVerticalChainsSize; i++) {
            ...
            if (currentWidget != null) {
                if (this.flags[1]) {
                    ...
                    ConstraintWidget widget = first;
                    boolean isWrapContent = this.mVerticalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? USE_SNAPSHOT : false;
