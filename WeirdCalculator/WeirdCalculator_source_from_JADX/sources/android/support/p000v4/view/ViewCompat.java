...
import android.support.p000v4.view.ViewCompatLollipop;
...
public class ViewCompat {
    ...
    static class LollipopViewCompatImpl extends KitKatViewCompatImpl {
        ...
        public void setOnApplyWindowInsetsListener(View view, final OnApplyWindowInsetsListener listener) {
            if (listener == null) {
                ViewCompatLollipop.setOnApplyWindowInsetsListener(view, (ViewCompatLollipop.OnApplyWindowInsetsListenerBridge) null);
            } else {
    ...
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo5to = 1.0d) float value) {
